...
class HeadPoseEstimator:
    ...
    def _draw_nose_axes(self, frame, rvec, tvec, model_img_lms):
        ...
        # Adjust the coordinates for the right lower part of the frame
        ...
        cv2.line(frame, (nose[0]+offset_x, nose[1]+offset_y), (nose_x[0] + offset_x, nose_x[1] + offset_y), (255, 0, 0), 2)
        cv2.line(frame, (nose[0]+offset_x, nose[1]+offset_y), (nose_y[0] + offset_x, nose_y[1] + offset_y), (0, 255, 0), 2)
        cv2.line(frame, (nose[0]+offset_x, nose[1]+offset_y), (nose_z[0] + offset_x, nose_z[1] + offset_y), (0, 0, 255), 2)
