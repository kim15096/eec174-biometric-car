...
while(cap.isOpened()):
    ...
    for i, rect in enumerate(rects):
        ...
        cv2.polylines(img, [left_eye_box], isClosed=True, color=(255, 0, 0), thickness=2)
        cv2.polylines(img, [right_eye_box], isClosed=True, color=(255, 0, 0), thickness=2)
        ...
        if d_judge<0.2 and frames_since_last_blink>one_sec/3:
            blink_count += 1
            frames_since_last_blink = 0
